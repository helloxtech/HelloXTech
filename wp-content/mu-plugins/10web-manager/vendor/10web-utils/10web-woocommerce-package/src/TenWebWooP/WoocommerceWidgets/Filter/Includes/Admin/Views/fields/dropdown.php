...
$context['field_view'] = 'dropdown';
$fields_data = $context['field_data'];
?>


<div class="filter_popup_section filter_popup_section_filed tww_add_field_settings tww_Dropdown tww_disable">
    <div class="filter_popup_section_left">
        <div class="tww_filter_section_head">
            ...
            <div>
                <p class="tww_filter_container_title">Dropdown</p>
        ...
        <div class="tww_filter_field_settings">
            <div class="tww_input_block">
                ...
                <input type="text" data-el_id="tww_button_apply_dropdown" name="fieldName" class="tww_filter_admin_form_field tww_required_input tww_filter_field_name" id="tww_filter_field_name">
            </div>
            <div class="tww_input_block">
                <label class="tww_filter_admin_label" for="tww_filter_field_variations_dropdown">Source of options*</label>
                <select name="fieldVariation" class="tww_filter_admin_form_field tww_filter_field_variations" id="tww_filter_field_variations_dropdown">
    ...
    if ($source['id'] === 'Category') {
        ...
        <span id="tww_button_apply_dropdown" class="tww_button tww_button_apply tww_button_active">Apply</span>
    </div>
    </div>
