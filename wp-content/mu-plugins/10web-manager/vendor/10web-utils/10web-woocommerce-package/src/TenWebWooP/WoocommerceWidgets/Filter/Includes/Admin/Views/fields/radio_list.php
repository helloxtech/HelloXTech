...
$context['field_view'] = 'radio_list';
$fields_data = $context['field_data'];
?>


<div class="filter_popup_section filter_popup_section_filed tww_add_field_settings tww_RadioList tww_disable">
    <div class="filter_popup_section_left">
        <div class="tww_filter_section_head">
            ...
            <div>
                <p class="tww_filter_container_title">Radio list</p>
        ...
        <div class="tww_filter_field_settings">
            <div class="tww_input_block">
                ...
                <input type="text" data-el_id="tww_button_apply_radio_list" name="fieldName" class="tww_filter_admin_form_field tww_required_input tww_filter_field_name" id="tww_filter_field_name">
            </div>
            <div class="tww_input_block">
                <label class="tww_filter_admin_label" for="tww_filter_field_radioList">Source of options*</label>
                <select name="fieldVariation" class="tww_filter_admin_form_field tww_filter_field_variations" id="tww_filter_field_radioList">
        ...
        <div class="tww_button_container">
            <span id="tww_button_apply_radio_list" class="tww_button tww_button_apply tww_button_active">Apply</span>
        </div>
    </div>
