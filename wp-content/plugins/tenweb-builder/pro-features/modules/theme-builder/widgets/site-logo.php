...
use Tenweb_Builder\ElementorPro\Modules\ThemeBuilder\Classes\Control_Media_Preview;
	...
	protected function register_controls() {
		...
		$this->update_control(
			...
			[
				...
				'dynamic' => [
					'default' => \Elementor\Plugin::instance()->dynamic_tags->tag_data_to_tag_text( null, 'site-logo' ),
				],
			],
			[
				'recursive' => true,
