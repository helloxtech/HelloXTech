<?php
namespace Tenweb_Builder\ElementorPro\Modules\GlobalWidget\Widgets;
...
class Global_Widget extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		if ( $data && ! empty( $data['templateID'] ) ) {
			...
			$original_widget_type = \Elementor\Plugin::instance()->widgets_manager->get_widget_types(
