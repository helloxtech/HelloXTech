<?php
namespace Tenweb_Builder\ElementorPro\Modules\GlobalWidget;

use Elementor\Core\Documents_Manager;
use Elementor\Element_Base;
use Elementor\TemplateLibrary\Source_Local;
use Tenweb_Builder\ElementorPro\Base\Module_Base;
use Tenweb_Builder\ElementorPro\Modules\GlobalWidget\Documents\Widget;
...
class Module extends Module_Base {
	...
	public function __construct() {
        ...
        \Elementor\Plugin::instance()->data_manager->register_controller_instance( new Data\Controller() );
	}
	...
	public function remove_user_edit_cap( $allcaps, $caps, $args ) {
		\Elementor\Plugin::instance()->modules_manager->get_modules( 'dev-tools' )->deprecation->deprecated_function( __METHOD__, '3.1.0', '\Elementor\Plugin::instance()->documents->remove_user_edit_cap()' );

		return \Elementor\Plugin::instance()->documents->remove_user_edit_cap( $allcaps, $caps, $args );
	}
	...
	public function set_global_widget_included_posts_list( $post_id, $editor_data ) {
		...
		\Elementor\Plugin::instance()->db->iterate_data( $editor_data, function( $element_data ) use ( &$global_widget_ids ) {
			if ( isset( $element_data['templateID'] ) ) {
	...
	private function add_hooks() {
		...
		add_filter( 'tenweb_builder_settings', [ $this, 'add_templates_localize_data' ] );
