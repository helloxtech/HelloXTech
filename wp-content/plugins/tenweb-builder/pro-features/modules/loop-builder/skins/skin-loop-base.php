<?php
namespace Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Skins;

use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Documents\Loop;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Documents\Loop as LoopDocument;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Files\Css\Loop as Loop_CSS;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Files\Css\Loop_Preview;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Module;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Widgets\Base as Loop_Widget_Base;
use Tenweb_Builder\Widgets\Posts_Skins\Skins\Skin_Base;
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Controls\Group_Control_Related;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Files\Css\Loop_Dynamic_CSS;
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Traits\Alternate_Templates_Trait;
...
class Skin_Loop_Base extends Skin_Base {
	...
	public function render() {
		...
		if ( $current_document ) {
            \Elementor\Plugin::instance()->documents->switch_to_document( $current_document );
		}
	}
