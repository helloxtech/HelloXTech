<?php
namespace Tenweb_Builder\ElementorPro\Modules\LoopBuilder;
...
use Tenweb_Builder\ElementorPro\Modules\LoopBuilder\Skins\Skin_Loop_Post_Taxonomy;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_action('elementor/editor/init', function () {
            \Elementor\Plugin::instance()->common->add_template( __DIR__ . '/views/cta-template.php' );
		});
