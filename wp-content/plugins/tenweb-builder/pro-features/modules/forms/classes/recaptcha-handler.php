...
class Recaptcha_Handler {
	...
	public function register_scripts() {
		...
		wp_register_script( $script_name, $src, [], TWBB_VERSION, true );
	}
	...
	public function __construct() {
		...
		add_filter( 'elementor_tenweb/forms/field_types', [ $this, 'add_field_type' ] );
		add_action( 'elementor_tenweb/forms/render_field/' . static::get_recaptcha_name(), [ $this, 'render_field' ], 10, 3 );
		add_filter( 'elementor_tenweb/forms/render/item', [ $this, 'filter_field_item' ] );
        add_filter( 'tenweb_builder_settings', [ $this, 'localize_settings' ] );

		if ( static::is_enabled() ) {
			add_action( 'elementor_tenweb/forms/validation', [ $this, 'validation' ], 10, 2 );
