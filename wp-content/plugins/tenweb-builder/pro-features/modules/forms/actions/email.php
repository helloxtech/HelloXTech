<?php
namespace Tenweb_Builder\ElementorPro\Modules\Forms\Actions;
...
use Tenweb_Builder\ElementorPro\Modules\Forms\Classes\Form_Record;
...
class Email extends Action_Base {
	...
	public function run( $record, $ajax_handler ) {
		 ...
		 */
		$headers = apply_filters( 'elementor_tenweb/forms/wp_mail_headers', $headers );
		 ...
		 */
		$fields['email_content'] = apply_filters( 'elementor_tenweb/forms/wp_mail_message', $fields['email_content'] );
		 ...
		 */
		do_action( 'elementor_tenweb/forms/mail_sent', $settings, $record );
