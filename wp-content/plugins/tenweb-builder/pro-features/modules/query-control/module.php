<?php
namespace Tenweb_Builder\ElementorPro\Modules\QueryControl;
...
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Controls\Template_Query;
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Classes\Elementor_Post_Query;
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Classes\Elementor_Related_Query;
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Controls\Group_Control_Posts;
...
use Tenweb_Builder\ElementorPro\Modules\QueryControl\Controls\Query;
...
class Module extends Module_Base {
	...
	public static function add_exclude_controls( $widget ) {
		\Elementor\Plugin::instance()->modules_manager->get_modules( 'dev-tools' )->deprecation->deprecated_function( __METHOD__, '2.5.0', 'class Group_Control_Query' );
	...
	public function get_query_args( $control_id, $settings ) {
		\Elementor\Plugin::instance()->modules_manager->get_modules( 'dev-tools' )->deprecation->deprecated_function( __METHOD__, '2.5.0', 'class Elementor_Post_Query' );
	...
	public function register_ajax_actions( $ajax_manager ) {
		...
		$ajax_manager->register_ajax_action( 'twbb_panel_posts_control_filter_autocomplete', [ $this, 'ajax_posts_filter_autocomplete' ] );
		/**
		 * @deprecated 2.6.0 use new `autocomplete` format
		 */
		$ajax_manager->register_ajax_action( 'query_control_value_titles_deprecated', [ $this, 'ajax_posts_control_value_titles_deprecated' ] );
		$ajax_manager->register_ajax_action( 'twbb_panel_posts_control_filter_autocomplete_deprecated', [ $this, 'ajax_posts_filter_autocomplete_deprecated' ] );
	}
