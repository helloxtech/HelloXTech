...
class Group_Control_Query extends Group_Control_Base {
    ...
    //10Web customization
    /*
     * get taxonomies and post types for each post type
     */
    private static function get_query_controls(){
        $pt_options = array();
        $tax_options = array();
...
//                $fields['include_taxonomy_' . $pt . '_' . $tax] = [
//                    'label' => esc_html__( $tax_opt['title'], 'elementor-pro'),
//                    'type' => Controls_Manager::SELECT2,
