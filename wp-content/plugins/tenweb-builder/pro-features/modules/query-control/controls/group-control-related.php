...
class Group_Control_Related extends Group_Control_Query {
	...
	protected function init_fields_by_name( $name ) {
		...
		$fields['include_term_ids_tags']['condition']['post_type!'][] = 'related';
		...
		$fields = \Elementor\Utils::array_inject( $fields, 'include_term_ids_tags', [ 'related_taxonomies' => $related_taxonomies ] );
