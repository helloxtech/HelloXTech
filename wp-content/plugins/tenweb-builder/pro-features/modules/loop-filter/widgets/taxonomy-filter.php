<?php
namespace Tenweb_Builder\ElementorPro\Modules\LoopFilter\Widgets;
...
use Tenweb_Builder\ElementorPro\Modules\LoopFilter\Traits\Hierarchical_Taxonomy_Trait;
...
class Taxonomy_Filter extends Base_Widget {
	...
	private function get_loop_widget_settings() {
		$document = \Elementor\Plugin::instance()->documents->get_doc_for_frontend( $this->get_current_ID() );
	...
	public function render() {
		...
		$active_filters = [];
		$loop_filter_module = \Elementor\Plugin::instance()->modules_manager->get_modules( 'loop-filter' );
