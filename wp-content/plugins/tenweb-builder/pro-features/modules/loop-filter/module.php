<?php
namespace Tenweb_Builder\ElementorPro\Modules\LoopFilter;

use Elementor\Core\Experiments\Manager;
use Tenweb_Builder\ElementorPro\Base\Module_Base;
use Tenweb_Builder\ElementorPro\Core\Utils;
use Tenweb_Builder\ElementorPro\Modules\LoopFilter\Query\Taxonomy_Query_Builder;
use Tenweb_Builder\ElementorPro\Modules\LoopFilter\Query\Data\Query_Constants;
...
class Module extends Module_Base {
	...
	public static function is_active() {
		return \Elementor\Plugin::instance()->experiments->is_feature_active( static::EXPERIMENT_NAME );
	}
