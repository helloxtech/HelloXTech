...
class Icons_Manager {
	...
	public function post_updated_messages( $messages ) {
		$messages[ self::CPT ] = [
			...
			5 => isset( $_GET['revision'] ) ? sprintf( esc_html__( 'Icon Set restored to revision from %s', 'elementor-pro' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,//phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	public function redirect_admin_old_page_to_new() {
		if ( ! empty( $_GET['page'] ) && 'elementor_custom_icons' === $_GET['page'] ) {//phpcs:ignore WordPress.Security.NonceVerification.Recommended
