...
class Typekit_Fonts extends Font_Base {
	...
	public function handle_panel_request( array $data ) {
		...
		if ( ! in_array( $font_family, array_keys( $typekit_fonts ) ) ) {//phpcs:ignore WordPress.PHP.StrictInArray.MissingTrueStrict
	...
	public function print_font_link( $font ) {
		...
		if ( $this->is_font_in_kit( $font ) ) {
			...
			echo '<link rel="stylesheet" type="text/css" href="' . esc_url( $kit_url ) . '">';//phpcs:ignore WordPress.WP.EnqueuedResources.NonEnqueuedStylesheet
	...
	private function is_font_in_kit( $font ) {
		...
		return in_array( $font, array_keys( $kit_fonts ) );//phpcs:ignore WordPress.PHP.StrictInArray.MissingTrueStrict
	}
