...
class Custom_Icons extends  Assets_Base {
	...
	public function save_post_meta( $post_id, $post, $update ) {
		...
		update_post_meta( $post_id, self::META_KEY, json_encode( $json ) );//phpcs:ignore WordPress.WP.AlternativeFunctions.json_encode_json_encode
	...
	private function upload() {
		...
		if ( 'zip' !== $ext ) {
			unlink( $filename );//phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.file_ops_unlink
	...
	private function extract_zip( $file, $to ) {
		...
		@unlink( $file );//phpcs:ignore Generic.PHP.NoSilencedErrors.Forbidden, WordPressVIPMinimum.Functions.RestrictedFunctions.file_ops_unlink
