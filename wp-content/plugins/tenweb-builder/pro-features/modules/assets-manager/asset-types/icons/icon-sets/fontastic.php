...
class Fontastic extends Icon_Set_Base {
	...
	protected function prepare() {
		$this->data = file_get_contents( $this->directory . $this->stylesheet_file );//phpcs:ignore WordPressVIPMinimum.Performance.FetchingRemoteData.FileGetContentsUnknown
	}
