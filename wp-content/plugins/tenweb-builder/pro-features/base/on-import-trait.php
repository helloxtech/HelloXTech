<?php
namespace Tenweb_Builder\ElementorPro\Base;
...
trait On_Import_Trait {
	...
	public static function on_import_update_dynamic_content( array $element_config, array $data, $controls = null ) : array {
		...
		$available_control_types = \Elementor\Plugin::instance()->controls_manager->get_controls();
	...
	private static function on_import_check_post_type( string $control_name ) : bool {
		return strpos( $control_name, 'post_ids' ) !== false || in_array( $control_name, [ 'post_id', 'template_id', 'popup' ], true );
	}
